...
export interface ChainlinkClientUpgradableInterface extends utils.Interface {
  functions: {};
...
export interface ChainlinkClientUpgradable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChainlinkClientUpgradableInterface;
