...
export interface GroupMatchInterface extends utils.Interface {
  functions: {
...
export type MatchScoreUpdatedEvent = TypedEvent<
  [string, BigNumber, GDataTypes.ScoreStructOutput],
...
export interface GroupMatch extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GroupMatchInterface;
