...
export interface HandicapGroupPredictInterface extends utils.Interface {
  functions: {
...
export interface HandicapGroupPredict extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HandicapGroupPredictInterface;
